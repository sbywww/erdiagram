...
export function RightPanel({ tableId, onClose }: RightPanelProps) {
  ...
  return (
    <div className="w-[360px] h-full border-l border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 flex flex-col shrink-0">
      {/* Header */}
